...
import SAdminSchedule from './SAmodal';
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const fileName = `SuperAdmin-schedule-${date}.xlsx`;
  ...
  return (
    <main className="super-admin-table-container">
      <div className='super-admin-title'>
        <AdminHeader title="Super Admin Schedules" />
      </div>
...
export default SuperAdminSchedules;